...
public class CardDisplay : MonoBehaviour {
    ...
    private void Update()
    {
        ...
        {
            initandstart(-157,-150.9f,0);  
            initandstart(5, -150.9f, 0);
            initandstart(166, -150.9f, 0);
            initandstart(332, -150.9f, 0);
        }
    }
     ...
     */
    public GameObject initandstart(float x, float y, float z)                                                              
    {
