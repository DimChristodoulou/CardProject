...
public class graveyard : MonoBehaviour {
    ...
    public void refreshTopGraveyardCard()
    {
        ...
        clonedCard = topGraveyardCard.initializeCard(graveyardGO.transform.localPosition.x, graveyardGO.transform.localPosition.y, graveyardGO.transform.localPosition.z, GameState.getActivePlayer().graveyard[GameState.getActivePlayer().graveyard.Count - 1].GetComponent<CardDisplay>().id);
